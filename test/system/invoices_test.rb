...
class InvoicesTest < ApplicationSystemTestCase
  ...
  test "creating a Invoice" do
    ...
    fill_in "Customer no", with: @invoice.customer_no
    fill_in "Custoner name", with: @invoice.custoner_name
    fill_in "Date", with: @invoice.date
    fill_in "Sale person code", with: @invoice.sale_person_code
    fill_in "Sale person name", with: @invoice.sale_person_name
